...
<html>
    ...
    <!-- la page ==============================================-->
      ...
      <a href="img/novotel-stg.jpg "> <img class="illustration" alt="" src="img/novotel-stg.jpg" /></a>
      <p>Hôtel 4* pour des séjours familials.<br/>
      ...
      <p>La chambre double est à partir de 60.000$.</p>

            
      <p>Services inclus : petit-déjeuner, climatisation, parking, Wi-Fi, salle de sport.
      </p>
...
<img src="img/novotel-stg-1.jpg" alt>
<img src="img/novotel-stg-2.jpg" alt>
<img src="img/novotel-stg-3.jpg" alt>
<img src="img/novotel-stg-4.jpg" alt>
<img src="img/novotel-stg-5.jpg" alt>
<img src="img/novotel-stg-6.jpg" alt>
<img src="img/novotel-stg-7.jpg" alt>
<img src="img/novotel-stg-8.jpg" alt>
</div>
</div>
</div>  
...
<div class="hr-divider"></div>
      ...
      <?php 
        $page = 'novotel';  /* Mettre le nom de l'hotel */
