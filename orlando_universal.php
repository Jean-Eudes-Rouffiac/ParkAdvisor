  ...
  <head>
    ...
    <!-- la page ==============================================-->
        ...
        <div class="page">
          ...
          <div class="titre">
            <h1>Orlando Universal Resort</h1>  
          </br>     
          </div>
      <!-- /. PAGE TITLE-->

  
      <a href="img/orlando_universal.jpg "> <img class="illustration" alt="" src="img/orlando_universal.jpg" /></a>
      <p><!--Fantasilandia est un parc d'attractions pour tous les goûts et pour tout âge.<br/>-->Le parc est divisé en plusieurs zones et offre l’occasion de vivre mille et une expériences délicieusement riches en sensations fortes. Préparez-vous à vous retrouver face à face avec les dinosaures de Jurassic Parc, à vous baigner avec d’illustres personnages de cartoons, à faire un tour de montagnes russes vertigineuses sous le regard de l’Incroyable Hulk… On ne compte pas les « grand huit » capables de vous mettre la tête à l’envers ! L’attraction vedette du parc, The Amazing Adventures of SpiderMan emporte les visiteurs, les cinq sens en éveil, dans un vaisseau qui évolue dans l’univers (en 3D) de l’homme-araignée</p>
      ...
      <p><a href="img/orlando_universal_map.jpg" target="_blank">Plan du parc</a></p>
...
<img src="img/orlando_universal_img1.jpg" alt>
<img src="img/orlando_universal_img2.jpg" alt>
<img src="img/orlando_universal_img3.jpg" alt>
<img src="img/orlando_universal_img4.jpg" alt>
<img src="img/orlando_universal_img5.jpg" alt>
<img src="img/orlando_universal_img6.jpg" alt>
<img src="img/orlando_universal_img7.jpg" alt>
<img src="img/orlando_universal_img8.jpg" alt>
</div>
</div>
</div>  
